...
resource "aws_api_gateway_deployment" "api" {
  ...
  triggers = {
    ...
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.todo_items,
      aws_api_gateway_resource.todo_item,
      aws_api_gateway_method.post_todo_list,
      ...
      aws_api_gateway_method.delete_todo_list,
      aws_api_gateway_integration.delete_todo_list,
      aws_api_gateway_method.post_todo_item,
      aws_api_gateway_integration.post_todo_item,
      aws_api_gateway_method.get_todo_item,
      aws_api_gateway_integration.get_todo_item,
      aws_api_gateway_method.get_all_todo_items,
      aws_api_gateway_integration.get_all_todo_items,
      aws_api_gateway_method.update_todo_item,
      aws_api_gateway_integration.update_todo_item,
      aws_api_gateway_method.delete_todo_item,
